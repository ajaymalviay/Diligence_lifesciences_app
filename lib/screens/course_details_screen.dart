          ...
          Row(
            ...
            children: [
              if (details.course.discountPrice != null)
                Text(
                    "${currencySymbol(currency)} ${(num.parse(details.course.discountPrice.toString()) * selectedCurrencyRate)}",
                    style: TextStyle(
                        fontWeight: FontWeight.bold,
                        fontSize: 22.0,
                        color: Color(0xff404455))),
              ...
              Text(
                "${currencySymbol(currency)} ${(num.parse(details.course.price.toString()) * selectedCurrencyRate)}",
                style: TextStyle(
                ...
                child: Align(
                  ...
                  child: Text(
                    ...
                    style: TextStyle(
                      fontWeight: FontWeight.bold,
                      color:
                          tabIndex == 0 ? Color(0xff659833) : Colors.grey[600],
                    ),
                  ),
                ),
              ),
                ...
                if (details.review != null)
                  SliverList(
                    delegate: SliverChildBuilderDelegate(
                      ...
                      childCount:
                          details.review.length > 3 ? 3 : details.review.length,
                    ),
                  )
                else
                  SliverToBoxAdapter(
